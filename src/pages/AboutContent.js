...
안녕하세요.<br/> 1년 6개월 차 주니어 웹 프론트엔드 개발자 입니다.<br/> 나만 이해 하는 있는 코드가 아닌 남들이 보기에도 이해가 잘 되는 코드를 쓰려고 생각하고 노력합니다. <br/>근무할 때 웹 퍼블리싱 과 프론트 작업도 같이 해서 기본적으로 HTML, CSS,JS 경험이 있고,<br/>
디자인도 아름다우면서 사용자의 편의성을 고려해 사용하기<br/> 편한 웹을 제작하기 위해 끊임없이 고민하고 새로운 언어를 배우는 것을 두려워 하지 않은 성장하는 개발자입니다.
</span>
</div>
